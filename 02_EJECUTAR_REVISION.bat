...
echo.
echo Ejecutando generador nativo de SOLIDWORKS - REVISION COMPLETA A1...
echo Stage 1: OML, boss, envolvente y fairing.
echo Stage 2: toma chin, ducto, escapes y entradas NACA.
...
if not "%ERR%"=="0" (
  ...
  echo Resultados en generated\A1.
  echo Abra ALA_REVIEW_NACELA_DER_A1.SLDASM o use 03_ABRIR_ULTIMO_RESULTADO.bat.
